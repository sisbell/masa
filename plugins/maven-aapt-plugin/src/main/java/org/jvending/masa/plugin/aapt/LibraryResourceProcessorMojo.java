 ...
 * @description
 */
public class LibraryResourceProcessorMojo
    extends AbstractMojo
{
        ...
        throws MojoExecutionException, MojoFailureException
    {
        ...
        for ( Artifact artifact : (Set<Artifact>) project.getDependencyArtifacts() )
        {
            ...
            getLog().info( "Found library dependency: id = " + artifact.getArtifactId() + "," + lib.getAbsolutePath() );
            if ( lib.exists() )
            {
                try
                {
    ...
    private void unpackAndAddResources( File out )
